...
Cluster chạy êm suốt mấy ngày, không CrashLoopBackOff nào mới. Sáng nay bạn định `git add project/infs/` để commit nốt đống YAML mấy hôm nay, dừng tay giữa chừng. Mở lại `postgres.yaml`, nhìn thẳng vào dòng đó — cái dòng đã gõ tay từ Chương 8, chưa từng nghĩ lại:
