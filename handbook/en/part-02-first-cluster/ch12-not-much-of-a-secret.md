...
The cluster's been quiet for days, no new CrashLoopBackOff. This morning, about to `git add project/infs/` to commit the last few days' worth of YAML, you stop halfway through. You open `postgres.yaml` again, look straight at the line you typed back in Chapter 8 and never thought about again:
